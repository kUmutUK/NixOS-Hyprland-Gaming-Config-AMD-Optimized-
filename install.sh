...
echo -e "${RED}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo ""
echo -e "  1. Update disk UUIDs in ${CYAN}/etc/nixos/hardware-configuration.nix${NC}:"
...
if [[ "$GPU_VENDOR" == "nvidia" && "$PATCH_GPU" == true ]]; then
  echo -e "  2. Add NVIDIA-specific options to ${CYAN}/etc/nixos/configuration.nix${NC}:"
  echo -e "       hardware.nvidia.modesetting.enable = true;"
  echo -e "       hardware.nvidia.open = false;"
  echo ""
fi
echo -e "  3. Add your SSH public key (password auth is disabled):"
echo -e "${CYAN}       ssh-copy-id -i ~/.ssh/id_ed25519.pub localhost@nixos${NC}"
echo ""
echo -e "  4. When everything looks correct, rebuild:"
