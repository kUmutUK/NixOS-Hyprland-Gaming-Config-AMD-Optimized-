...
# Hyprland + Waybar + Catppuccin Mocha
# =============================================================================
...

{
  ...
  programs = {
    ...
    # -----------------------------------------------------------------------
    # WAYBAR - stil ve config home.file üzerinden yönetilir
    # -----------------------------------------------------------------------
    waybar = {
      enable = true;
    };
  ...
  home.file = {
    ...
    ".config/hypr/hyprlock.conf".source = ./user/hypr/hyprlock.conf;
  ...
  # =========================================================================
  # PAKETLER (home-manager üzerinden)
  # =========================================================================
  ...
  home.packages = with pkgs; [
    ...
    wev          # Wayland event viewer (debug)
  ];
